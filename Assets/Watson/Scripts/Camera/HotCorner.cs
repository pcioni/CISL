...
namespace IBM.Watson.DeveloperCloud.Camera
{
    ...
    public class HotCorner : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            EventManagerWatson.Instance.RegisterEventReceiver("OnTripleTap", TapThreeTimes);
        }

        void OnDisable()
        {
            EventManagerWatson.Instance.UnregisterEventReceiver("OnTripleTap", TapThreeTimes);
        }
        ...
        void TapThreeTimes(System.Object[] args = null)
        {
            if (args != null && args.Length > 0 && args[0] is TouchScript.Gestures.TapGesture)
            {
                ...
                {
                    EventManagerWatson.Instance.SendEvent("OnTripleTapBottomLeft");
                }
                ...
                {
                    EventManagerWatson.Instance.SendEvent("OnTripleTapTopLeft");
                }
                ...
                {
                    EventManagerWatson.Instance.SendEvent("OnTripleTapBottomRight");
                }
                ...
                {
                    EventManagerWatson.Instance.SendEvent("OnTripleTapTopRight");
                }
                ...
                {
                    EventManagerWatson.Instance.SendEvent("OnTripleTapMiddleLeft");
                }
                ...
                {
                    EventManagerWatson.Instance.SendEvent("OnTripleTapMiddleRight");
                }
                ...
                {
                    EventManagerWatson.Instance.SendEvent("OnTripleTapMiddleBottom");
                }
                ...
                {
                    EventManagerWatson.Instance.SendEvent("OnTripleTapMiddleTop");
                }
                else
                {
                    //	do nothing
