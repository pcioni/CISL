...
namespace IBM.Watson.DeveloperCloud.Debug
{
    ...
    public class DebugConsole : MonoBehaviour
    {
        ...
        {
            EventManagerWatson.Instance.RegisterEventReceiver("OnDebugMessage", OnDebugMessage);

            EventManagerWatson.Instance.RegisterEventReceiver("OnDebugToggle", OnToggleActive);
            EventManagerWatson.Instance.RegisterEventReceiver("OnKeyboardBackquote", OnToggleActive);

            EventManagerWatson.Instance.RegisterEventReceiver("OnDebugBeginCommand", OnBeginEdit);
            EventManagerWatson.Instance.RegisterEventReceiver("OnKeyboardReturn", OnBeginEdit);
        }

        private void OnDisable()
        {
            EventManagerWatson.Instance.UnregisterEventReceiver("OnDebugMessage", OnDebugMessage);

            EventManagerWatson.Instance.UnregisterEventReceiver("OnDebugToggle", OnToggleActive);
            EventManagerWatson.Instance.UnregisterEventReceiver("OnKeyboardBackquote", OnToggleActive);

            EventManagerWatson.Instance.UnregisterEventReceiver("OnDebugBeginCommand", OnBeginEdit);
            EventManagerWatson.Instance.UnregisterEventReceiver("OnKeyboardReturn", OnBeginEdit);
        }
        ...
        private void OnToggleActive(object[] args)
        {
            ...
            EventManagerWatson.Instance.SendEvent("OnDebugToggleFinish");
        }
        ...
        public void OnEndEdit()
        {
            if (m_CommandInput != null)
            {
                EventManagerWatson.Instance.SendEvent("OnDebugCommand", m_CommandInput.text);
