    ...
    public class TouchEventManager : MonoBehaviour
    {
        ...
        private void OneFingerTransformedHandler(object sender, System.EventArgs e)
        {
            ...
            if (m_Active)
            {
                ...
                if (dragEventToFire != null)
                    EventManagerWatson.Instance.SendEvent(dragEventToFire.DragCallback, m_OneFingerMoveGesture, hit, hit2D);

                EventManagerWatson.Instance.SendEvent("OnDragOneFingerFullscreen", m_OneFingerMoveGesture);
            }
        }
        ...
        private void TwoFingerTransformedHandler(object sender, System.EventArgs e)
        {
            ...
            if (m_Active)
            {
                ...
                if (dragEventToFire != null)
                    EventManagerWatson.Instance.SendEvent(dragEventToFire.DragCallback, m_TwoFingerMoveGesture);

                EventManagerWatson.Instance.SendEvent("OnDragTwoFingerFullscreen", m_TwoFingerMoveGesture);
            }
        }
        #endregion
        ...
        private void TapGesture_Tapped(object sender, System.EventArgs e)
        {
            if (m_Active)
            {
                ...
                if (tapEventToFire != null)
                    EventManagerWatson.Instance.SendEvent(tapEventToFire.TapCallback, m_TapGesture, hitToFire);

                EventManagerWatson.Instance.SendEvent("OnSingleTap", m_TapGesture);
            }
        }
        #endregion
        ...
        private void DoubleTapGesture_Tapped(object sender, System.EventArgs e)
        {
            if (m_Active)
            {
                ...
                if (tapEventToFire != null)
                    EventManagerWatson.Instance.SendEvent(tapEventToFire.TapCallback, m_DoubleTapGesture, hitToFire);

                EventManagerWatson.Instance.SendEvent("OnDoubleTap", m_DoubleTapGesture);
            }
...
#endif
                EventManagerWatson.Instance.SendEvent("OnTripleTap", m_ThreeTapGesture);
            }
        }
        ...
        private void PressGesturePressed(object sender, System.EventArgs e)
        {
            ...
            EventManagerWatson.Instance.SendEvent("OnTouchPressedFullscreen", m_PressGesture);
        }
        ...
        private void LongPressGesturePressed(object sender, System.EventArgs e)
        {
            ...
            EventManagerWatson.Instance.SendEvent("OnLongPressOneFinger", m_LongPressGesture);
        }
        ...
        private void ReleaseGestureReleased(object sender, System.EventArgs e)
        {
            ...
            EventManagerWatson.Instance.SendEvent("OnTouchReleasedFullscreen", m_ReleaseGesture);
        }
        #endregion
    }
