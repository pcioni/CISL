...
namespace IBM.Watson.DeveloperCloud.Utilities
{
    ...
    /// </summary>
    public class EventManagerWatson
    {
        #region Public Properties
        /// <summary>
        /// Returns the singleton event manager instance.
        /// </summary>
        public static EventManagerWatson Instance { get { return Singleton<EventManagerWatson>.Instance; } }
        #endregion
        ...
        /// <summary>
        /// Register an event receiver with this EventManagerWatson.
        /// </summary>
        ...
        public bool SendEvent(string eventName, params object[] args)
        {
            ...
            if (m_EventMap.TryGetValue(eventName, out receivers))
            {
                for (int i = 0; i < receivers.Count; ++i)
                {
                    if (receivers[i] == null)
                    {
                        Log.Warning("EventManagerWatson", "Removing invalid event receiver.");
                    ...
                    {
                        Log.Error("EventManagerWatson", "Event Receiver Exception: {0}", ex.ToString());
                    }
                }
                return true;
            }
