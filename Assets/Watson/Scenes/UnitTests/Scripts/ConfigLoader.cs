...
public class ConfigLoader : MonoBehaviour
{
    ...
    void OnEnable()
    {
        EventManagerWatson.Instance.RegisterEventReceiver("OnUserToLogout", OnUserLogOut);
    }

    void OnDisable()
    {
        EventManagerWatson.Instance.UnregisterEventReceiver("OnUserToLogout", OnUserLogOut);
    }
    #endregion
