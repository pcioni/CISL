...
public class new_NodeController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (is_focus_node && !loader_object.GetComponent<Loader>().single_node_mode)
        {
            ...
            {
                neighbor_node.GetComponent<new_NodeController>().DrawLineToNode(gameObject, relationship_list[adjacency_list.IndexOf(neighbor_node)]);
            }//end foreach
        }//end if
